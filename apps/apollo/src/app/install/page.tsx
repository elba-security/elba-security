      ...
      <div className={styles.modal}>
        ...
        {active === '1' && (
          <InstructionItems
            heading="Settings"
            instructions={[
              'In the Apollo Dashboard, use the left navigation bar.',
              'Navigate to the Settings.',
              'Scroll down and click on Integrations.',
              'Navigate to the API tab and click on connect.',
              'Under API Management, click on API Key',
            ]}
          />
        )}
        {active === '2' && (
          <InstructionItems
            ...
            instructions={[
              ...
              'Provide the Description for the API Key.',
              'Select an API to associate this Key or set as a Master Key.',
              'Click Create API Key.',
            ]}
          />
        )}
        {active === '3' && (
          <>
            <InstructionItems
              ...
              instructions={[
                'On API key page, API Keys will be shown with their name.',
                'Copy your desired API Key.',
