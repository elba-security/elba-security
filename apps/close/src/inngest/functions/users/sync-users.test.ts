...
import * as usersConnector from '@/connectors/close/users';
...
const nextPage = 1;
const organizationUri = 'test-org-1';
...
const users: usersConnector.CloseUser[] = Array.from({ length: 3 }, (_, i) => ({
...
const setup = createInngestFunctionMock(syncUsers, 'close/users.sync.requested');
