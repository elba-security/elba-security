...
// import { organisationsTable, oneDriveTable } from '@/database/schema';
...
//   initializeDelta,
//   'onedrive/data_protection.initialize_delta.requested'
// );
...
//     expect(step.invoke).toBeCalledWith('onedrive/subscriptions.create.triggered', {
...
//       .select({
//         subscriptionId: oneDriveTable.subscriptionId,
//         subscriptionExpirationDate: oneDriveTable.subscriptionExpirationDate,
//         delta: oneDriveTable.delta,
//       })
//       .from(oneDriveTable)
//       .where(
//         and(
//           eq(oneDriveTable.organisationId, organisation.id),
//           eq(oneDriveTable.siteId, siteId),
//           eq(oneDriveTable.driveId, driveId)
//         )
//       );
