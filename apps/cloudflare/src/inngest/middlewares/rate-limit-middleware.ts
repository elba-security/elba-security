 ...
 * The middleware checks for specific errors (instances of CloudflareError) that indicate a rate limit has been reached,
 ...
 * - Handles CloudflareError, specifically looking for a 'Retry-After' header in the error response.
