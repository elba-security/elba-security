...
describe('sync-users', () => {
  ...
  test('should continue the sync when there is a next page', async () => {
    ...
    vi.spyOn(usersConnector, 'getTokenInfo').mockResolvedValue(tokenInfo);
    vi.spyOn(usersConnector, 'getAuthUser').mockResolvedValue(authUser);
