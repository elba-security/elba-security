...
export const env = z
  .object({
    ...
    HEROKU_CLIENT_ID: z.string(),
    HEROKU_CLIENT_SECRET: z.string(),
    HEROKU_REDIRECT_URI: z.string().url(),
    HEROKU_TOKEN_REFRESH_RETRIES: zEnvRetry().default(5),
    HEROKU_TOKEN: z.string(),
  })
  .parse(process.env);
